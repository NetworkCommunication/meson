...
from offloading_ddqn.lstm_ddqn import DDQNTO_number, DDQNTO_trans


def train(args):
    # Here is some global configuration for the datapath
    graph_paths_train_for_number = ["./meson/offloading_data/offload_random10/random.10.",
                              "./meson/offloading_data/offload_random15/random.15.",
                              "./meson/offloading_data/offload_random20/random.20.",
                              "./meson/offloading_data/offload_random25/random.25.",
                              "./meson/offloading_data/offload_random30/random.30.",
                              "./meson/offloading_data/offload_random35/random.35.",
                              "./meson/offloading_data/offload_random40/random.40.",
                              "./meson/offloading_data/offload_random45/random.45.",
                              "./meson/offloading_data/offload_random50/random.50.",
                              ]
    graph_paths_test_for_number = ["./meson/offloading_data/offload_random10_test/random.10.",
                         "./meson/offloading_data/offload_random15_test/random.15.",
                         "./meson/offloading_data/offload_random20_test/random.20.",
                         "./meson/offloading_data/offload_random25_test/random.25.",
                         "./meson/offloading_data/offload_random30_test/random.30.",
                         "./meson/offloading_data/offload_random35_test/random.35.",
                         "./meson/offloading_data/offload_random40_test/random.40.",
                         "./meson/offloading_data/offload_random45_test/random.45.",
                         "./meson/offloading_data/offload_random50_test/random.50."
                         ]

    graph_paths_train_for_trans = ["./meson/offloading_data/offload_random15/random.15."]
    graph_paths_test_for_trans = ["./meson/offloading_data/offload_random15/random.15."]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--algo", type=str, default="DRLTO")
